...
function OrderProducts () {
    ...
    // useEffect(() => {
    //     fetch('https://laundry-app-server-apis.herokuapp.com/products')
    //         .then(response => response.json())
    //         .then(data => setProductDetails(data.message))          
    // },[]);
                    ...
                    {productDetails.map( (product, i) => 
                        <div className='product_details' key={product.product_id}>
                            <div className='product_type'>
                                <img className='product_img' src='https://images.unsplash.com/photo-1562157873-818bc0726f68?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=327&q=80' alt='clothes'></img>
